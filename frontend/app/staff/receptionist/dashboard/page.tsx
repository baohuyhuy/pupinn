...
export default function ReceptionistDashboardPage() {
  ...
  // 2. Fetch today's arrivals (upcoming bookings starting today)
  ...
  // 3. Fetch today's departures (checked_in bookings ending today)
  const { data: todayDepartures, isLoading: departuresLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Filter client-side for check_out_date match
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="bg-slate-800/80 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link href="/staff/receptionist/bookings?status=upcoming">
          ...
          <Card className="bg-slate-800/80 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link href="/staff/receptionist/bookings?status=checked_in">
                <Button variant="ghost" size="sm" className="text-slate-400">
                  View All <ArrowRight className="h-4 w-4 ml-1" />
                </Button>
              </Link>
