    ...
    <RouteGuard requiredRole="admin">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="bg-slate-800/80 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link href="/staff/admin/bookings?status=upcoming">
          ...
          <Card className="bg-slate-800/80 border-slate-700">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link href="/staff/admin/bookings?status=checked_in">
                <Button variant="ghost" size="sm" className="text-slate-400">
                  View All <ArrowRight className="h-4 w-4 ml-1" />
                </Button>
              </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link href="/staff/admin/bookings">
            <Card className="bg-slate-800/80 border-slate-700 hover:border-blue-500/50 transition-colors cursor-pointer group">
              <CardHeader>
                ...
                <CardTitle className="text-slate-100">Bookings</CardTitle>
                <CardDescription className="text-slate-400">
                  Manage reservations
                </CardDescription>
              </CardHeader>
          ...
          <Link href="/staff/admin/rooms">
            <Card className="bg-slate-800/80 border-slate-700 hover:border-emerald-500/50 transition-colors cursor-pointer group">
              <CardHeader>
                ...
                <CardTitle className="text-slate-100">Rooms</CardTitle>
                <CardDescription className="text-slate-400">
          ...
          <Link href="/staff/admin/housekeeping">
